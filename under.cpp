////////////////////////////////////////////
// È lo stesso codice di peaks_triple.cpp
// ma seleziona le tracce se il segnale
// scende sotto Nstd deviazioni standard
// rispetto alla baseline senza altre condizioni
//
...
void under(){
///////////////////////////////////////////////////////////////////////////////////////// SELEZIONE OUTPUT:	
//	TFile *f = new TFile("file_out_threshold_copy.root","READ");     //
	TFile *f = new TFile("data_2022_02_03_09h04_copy.root","READ");  //
//	TFile *f = new TFile("data_2022_07_23_09h22_copy.root","READ");  //
/////////////////////////////////////////////////////////////////////////////////////////
	...
	/////////////////////////////////////////// UUB
	/////////////////////////////////////////// Istogramma di tutti gli ADC sotto la baseline
	///////////////////////////////////////////
...
//	canvas2->Close();
	...
	///////////////////////////////////////////
	/////////////////////////////////////////// Distribuzione massimi che siano (ipoteticamente) dati da fenomeni da fulmine
	///////////////////////////////////////////
	...
	for(int i=0; i<nentries; i++){
		...
		if((TflagUUB)and(FFlag1 and FFlag2 and FFlag3)){					
					...
					peak_histo_UUB_HG->Fill(newmax5*scale_fact);
		}
...
//	canvas_p2->Print();
	...
	canvas_p2->Close();
///////////////////////////////////////////////////////////////////////////////////////// SELEZIONE OUTPUT:	
//	TFile *small_file = new TFile("file_out_threshold_sel_under.root","RECREATE");     //
	TFile *small_file = new TFile("data_2022_02_03_09h04_sel_under.root","RECREATE");  //
//	TFile *small_file = new TFile("data_2022_07_23_09h22_sel_under.root","RECREATE");  //
/////////////////////////////////////////////////////////////////////////////////////////
...
//	TFile *big_file = new TFile("file_out_threshold_unsel_under.root","RECREATE");     //
	TFile *big_file = new TFile("data_2022_02_03_09h04_unsel_under.root","RECREATE");  //
//	TFile *big_file = new TFile("data_2022_07_23_09h22_unsel_under.root","RECREATE");  //
///////////////////////////////////////////////////////////////////////////////////////
