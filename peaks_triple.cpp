...
void peaks_triple(){
//////////////////////////////////////////////////////////////////////// SELEZIONE FILE:
//	TFile *f = new TFile("file_out_threshold_copy.root");	// (Primo)	
	TFile *f = new TFile("data_2022_02_03_09h04_copy.root");	// 3 Feb
//	TFile *f = new TFile("data_2022_07_23_09h22_copy.root");	// 23 Lug
///////////////////////////////////////////////////////////////////////
	...
	/////////////////////////////////////////// UUB
	/////////////////////////////////////////// Istogramma di tutti gli ADC nei primi 100 bins
	///////////////////////////////////////////
...
*/
	...
	canvas_p2->Close();
///////////////////////////////////////////////////////////////////////////////////////// SELEZIONE OUTPUT:	
//	TFile *small_file = new TFile("file_out_threshold_sel_tr.root","RECREATE");     //
	TFile *small_file = new TFile("data_2022_02_03_09h04_sel_tr.root","RECREATE");  //
//	TFile *small_file = new TFile("data_2022_07_23_09h22_sel_tr.root","RECREATE");  //
/////////////////////////////////////////////////////////////////////////////////////////
...
//	TFile *big_file = new TFile("file_out_threshold_unsel.root","RECREATE");     //
	TFile *big_file = new TFile("data_2022_02_03_09h04_unsel.root","RECREATE");  //
//	TFile *big_file = new TFile("data_2022_07_23_09h22_unsel.root","RECREATE");  //
///////////////////////////////////////////////////////////////////////////////////////
